          ...
          <AnimatePresence mode="wait">
            {!activeThread ? (
              ...
              >
                ...
                {listingDetails && (
                  <div className="mx-5 my-2 p-4 glass rounded-2xl text-xs space-y-3 shadow-xl">
                    <div className="flex items-center justify-between border-b border-white/10 pb-2.5">
                      <span className="font-bold text-emerald-400 flex items-center gap-1.5 text-xs">
                        ...
                        Safe Escrow Swap Protection
                      </span>
                      <span className="text-[9px] uppercase font-bold text-emerald-400 px-2.5 py-0.5 border border-emerald-500/30 rounded-full bg-emerald-500/10">
                        {escrowTx ? `STATUS: ${escrowTx.status.replace('_', ' ').toUpperCase()}` : 'STATUS: INACTIVE'}
                      </span>
                    </div>
